...
st_write(df_oxbow_snap,
         dsn = "data_fmt/vector/epsg3722_minnesota_oxbow_snap.gpkg",
         append = FALSE)
...
saveRDS(df_oxbow_snap, file = "data_fmt/data_minnesota_oxbow_connectivity.RDS")

#df_oxbow_snap <- readRDS(file = "data_fmt/data_minnesota_oxbow_connectivity.rds")
