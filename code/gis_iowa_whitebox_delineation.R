...
wbt_raster_streams_to_vector(streams = "data_fmt/raster/epsg4326_iowa_fmt_stream_id_5km2.tif", 
                             ...
                             output = "data_fmt/vector/epsg4326_iowa_stream_network_5km2.shp")
...
line <- st_read(dsn = "data_fmt/vector",
                layer = "epsg4326_iowa_stream_network_5km2") %>% 
  st_set_crs(4326)
...
stream <- st_read(dsn = "data_fmt/vector",
                  layer = "epsg4326_iowa_stream_network_5km2_dummy") 
...
st_write(ia_dummmy,
         dsn = "data_fmt/vector/epsg4326_iowa_dummy_sites.shp",
         append = FALSE)
...
wbt_unnest_basins(d8_pntr = "data_fmt/raster/epsg4326_iowa_flow_dir_clip_reclass_5km2.tif",
                  pour_pts= "data_fmt/vector/epsg4326_iowa_dummy_sites.shp", # GPKG file is not accepted. Used SHP file.
...
st_write(wgs84_sf_ws_polygon,
         dsn = "data_fmt/vector/epsg4326_iowa_watersheds_dummy_5km2.shp",
         append = FALSE)

# join --------------------------------------------------------------------

# add line_id from site point file to watershed polygon attribute table
wbt_join_tables(input1 = "data_fmt/vector/epsg4326_iowa_watersheds_dummy_5km2.shp",
                pkey = "siteid",
                input2 = "data_fmt/vector/epsg4326_iowa_dummy_sites.shp",
                fkey = "siteid",
                import_field = "line_id")

# add area from watershed polygon file to stream line attribute table
wbt_join_tables(input1 = "data_fmt/vector/epsg4326_iowa_stream_network_5km2_dummy.shp",
                pkey = "line_id",
                input2 = "data_fmt/vector/epsg4326_iowa_watersheds_dummy_5km2.shp",
                fkey = "line_id",
                import_field = "area")
